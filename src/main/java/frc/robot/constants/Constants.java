...
public class Constants {
    ...
    public static final double shooterPresetRPM = 3200.0; // CHANGE THIS AT PRACTICE.
    public static final double shooterPresetFeederPower = 0.5; // CHANGE THIS AT PRACTICE.

    // Slot 0 PID gains for TalonFX onboard velocity control (1 kHz loop).
    public static final double shooterKp = 0.11; // CHANGE THIS AT PRACTICE.
    public static final double shooterKi = 0.0; // CHANGE THIS AT PRACTICE.
    public static final double shooterKd = 0.0; // CHANGE THIS AT PRACTICE.
    public static final double shooterKv = 12.0 / shooterMaxRps; // CHANGE THIS AT PRACTICE.
